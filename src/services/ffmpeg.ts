...
function subtitlesFilter(srtOrAssPath: string): string {
  ...
  const force =
    "Alignment=2,FontName=Forever Freedom Regular Font Regular,FontSize=100,Bold=1," +
    "PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,BackColour=&H00000000," +
    "Outline=3,Shadow=2,Spacing=2,MarginV=120,MarginL=40,MarginR=40";
  return (
    "subtitles='" +
    escaped +
    "':fontsdir='" +
...
export function createAssWordByWordFile(
  ...
  const header = [
    ...
    "Style: Default,Forever Freedom Regular Font Regular,100,&H00FFFFFF,&H00FFFFFF,&H00000000,&H00000000,1,0,0,0,100,100,2,0,1,3,2,40,40,120,0",
    "[Events]",
